              ...
              <div className="flex flex-col ml-8 w-3/5">
                ...
                <div className="flex ml-6 items-center">
                  <div className="flex items-center mr-4">
                    ...
                    <label htmlFor="BUSAN_UNIV" className="ml-2">부산대 맞춤법 검사기</label>
                  </div>
                  <div className="flex items-center mr-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <label htmlFor="JOB_KOREA" className="ml-2">잡코리아 맞춤법 검사기</label>
                  </div>
                </div>
              </div>
                {/* 검사설정 */}
                <div className="flex items-center w-full mt-5">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="flex items-center ml-7">
                      ...
                      />
                      <label htmlFor="file" className="ml-2">파일</label>
                    </div>
                    <div className="flex items-center ml-20">
                      <input type="radio" id="text" name="inputType" value="text"
                        ...
                        onChange={(e) => setInputType(e.target.value)}
                      />
                      <label htmlFor="text" className="ml-2">텍스트</label>
                    </div>
                  </div>
                </div>
                <div className="text-neutral-400 text-sm font-bold font-['Epilogue'] leading-normal pt-5 pl-28">
                  <div className="mb-2">* 파일 참고란<br/></div>
                  <div>&nbsp;허용 확장자 : *.docx, *.txt, *.hwp
                    <br/>&nbsp;문서 첨부 제한 : 0Byte/ 100.0MB<br/>&nbsp;파일 제한 크기 : 100MB<br/></div>
                </div>
              </div>
            </div>
          </div>
